...
const FloatingAddRows: React.FC<ButtonProps> = ({ dbTable, setRows }) => {
  return (
    <div
      className="cursor-pointer shadow-sm fixed bottom-10 left-[340px] z-50 flex h-9 -translate-y-1/2 items-center justify-center rounded-3xl bg-white border border-gray-100 transition focus:ring-2 focus:ring-blue-500 focus:outline-none"
      aria-label="Add"
    >
